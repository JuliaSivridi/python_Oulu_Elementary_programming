...
surface.write_to_png("sprites/tile_empty.png")

ctx.rectangle(2, 2, 36, 36)
ctx.set_source_rgb(230 / 255, 230 / 255, 230 / 255)
ctx.fill()

surface.write_to_png("sprites/tile_back.png")
...
surface.write_to_png("sprites/tile_flag.png")
...
for i in range(1, 9): 
    ...
    surface.write_to_png("sprites/tile_{}.png".format(i))
...
surface.write_to_png("sprites/tile_mine.png".format(i))
